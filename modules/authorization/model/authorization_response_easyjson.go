...
func easyjson1158570fDecodeAssetsModulesAuthorizationModel(in *jlexer.Lexer, out *AuthorizationResponse) {
...
func easyjson1158570fEncodeAssetsModulesAuthorizationModel(out *jwriter.Writer, in AuthorizationResponse) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AccessToken != "" {
...
func (v AuthorizationResponse) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1158570fEncodeAssetsModulesAuthorizationModel(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v AuthorizationResponse) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson1158570fEncodeAssetsModulesAuthorizationModel(w, v)
}
...
func (v *AuthorizationResponse) UnmarshalJSON(data []byte) error {
	...
	easyjson1158570fDecodeAssetsModulesAuthorizationModel(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AuthorizationResponse) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1158570fDecodeAssetsModulesAuthorizationModel(l, v)
}
